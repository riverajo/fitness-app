...
export type SearchUniqueExercisesQuery = {
	__typename?: 'Query';
	uniqueExercises: Array<{
		__typename?: 'UniqueExercise';
		id: string;
		name: string;
...
export type CreateWorkoutLogMutation = {
	__typename?: 'Mutation';
	createWorkoutLog: { __typename?: 'WorkoutLog'; id: string; name: string };
};
...
export type UniqueExercisesQuery = {
	__typename?: 'Query';
	uniqueExercises: Array<{
		__typename?: 'UniqueExercise';
		id: string;
...
export type CreateUniqueExerciseMutation = {
	__typename?: 'Mutation';
	createUniqueExercise: {
		__typename?: 'UniqueExercise';
		id: string;
		name: string;
		description?: string | null;
...
export const SearchUniqueExercisesDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'SearchUniqueExercises' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
...
} as unknown as DocumentNode<SearchUniqueExercisesQuery, SearchUniqueExercisesQueryVariables>;
export const CreateWorkoutLogDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'CreateWorkoutLog' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'CreateWorkoutLogInput' } }
					}
				}
			],
			selectionSet: {
...
} as unknown as DocumentNode<CreateWorkoutLogMutation, CreateWorkoutLogMutationVariables>;
export const UniqueExercisesDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
...
} as unknown as DocumentNode<UniqueExercisesQuery, UniqueExercisesQueryVariables>;
export const CreateUniqueExerciseDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'CreateUniqueExercise' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'CreateUniqueExerciseInput' } }
					}
				}
			],
			selectionSet: {
...
} as unknown as DocumentNode<CreateUniqueExerciseMutation, CreateUniqueExerciseMutationVariables>;
